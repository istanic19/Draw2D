...
{
    [Serializable]
    public class GrArc : BaseGraphic
    {
        ...
        public GrArc(Position location) : base(GraphicObject.Arc)
        {
            Location = location;
        ...
        public override void Draw(Graphics gr)
        {
            ...
            gr.DrawArc(LinePen, -_widthPixels / 2, -_heightPixels / 2, _widthPixels, _heightPixels, (float)StartAngle, (float)EndAngle);
        ...
        public override Region CalculateRegion()
        {
            ...
            _path.AddArc(-_widthPixels / 2, -_heightPixels / 2, _widthPixels, _heightPixels, (float)StartAngle, (float)EndAngle);
        ...
        {
            var clone = new GrArc(Location.Clone());
